...
<head>
  <title> Customer Login | FlavorWave </title>
</head>
  ...
  <div class="container" style="display: flex; flex-direction: column; justify-content: center; align-items: center;
    ...
    <div class="card-body text-center content-fade2">
      ...
      <p style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.1);">
        Click Login to start Explore the Flavor Zone <br>
        <a href="customerlogin.php" class="btn btn-primary" style="margin-top: 20px;">Login</a>
      </p>
    </div>
  </div>
