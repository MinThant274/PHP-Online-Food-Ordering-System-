...
<body>
  ...
  <br>
  <h1 class="text-center content-fade2">Grand Total: &#36;<?php echo "$gtotal"; ?>/-</h1>
  <h3 class="text-center content-fade2">including all service charges. (no delivery charges applied)</h3>
  <h5 class="text-center content-fade2">Choose Your Payment</h5>
  <br>
  <h1 class="text-center content-fade3">
